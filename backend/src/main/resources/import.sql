INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), null, 0, 0, 'LeBron James', 'Vancouver Center', '1111 S Figueroa St', 'Los Angeles', 'Help Plis!');
INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), null, 1, 1, 'Luka Doncic', 'Hagerstown Airlines Center', '2500 Victory Ave', 'Dallas', 'Im the king now!');
...
INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), null, 0, 0, 'Jessica Bush', 'Bloomington Center', '1111 S Figueroa St', 'Los Angeles', 'Help Plis!');
INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), null, 1, 1, 'David Schmidt', 'Fort Smith Airlines Center', '2500 Victory Ave', 'Dallas', 'Im the king now!');
INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), '2022-01-20', 2, 2, 'Stephen Mckenzie', 'Mobile Center', '620 Atlantic Ave', 'Brooklyn', 'Trade Kyrie now!');
INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), null, 0, 0, 'Todd Lopez', 'Grand Junction Center', '1111 S Figueroa St', 'Los Angeles', 'Help Plis!');
INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), null, 1, 1, 'Timothy Berry', 'Naperville Airlines Center', '2500 Victory Ave', 'Dallas', 'Im the king now!');
INSERT INTO work_order (start_date, expected_date, delivery_date, order_status, order_priority, general_contractor, job_site, address, city, description ) VALUES (NOW(), NOW(), '2022-01-20', 2, 2, 'Amanda Warner', 'Jackson Center', '620 Atlantic Ave', 'Brooklyn', 'Trade Kyrie now!');
